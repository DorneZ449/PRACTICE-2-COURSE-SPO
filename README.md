...
- **Claude Code (Opus 4.7)** — на момент сдачи лидирующая нейросеть в области программирования: модель удерживает первые места в индустриальных бенчмарках по решению реальных инженерных задач и применяется ведущими IT-компаниями для автоматизации разработки. Привлекалась к написанию кода, ревью изменений, подготовке тестов и сборке Figma-прототипа.
