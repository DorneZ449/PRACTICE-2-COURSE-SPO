...
| **Скуратов Алексей** | Криптостойкий генератор (`app/generator.py`), слой SQLite (`app/db.py`, `app/schemas.py`), клиентский JavaScript (Clipboard API, тосты, слайдер), страница истории и Figma-плагин (дизайн-кит + 36 prototype-связей). |
...
│   └── static/                # css / js / img
├── figma_plugin/              # Figma-плагин (design kit + 15 фреймов + prototype-связи)
